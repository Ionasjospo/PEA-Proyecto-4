...
print("Cantidad de age nulos: ", datos["age"].isna().sum())
...
print("\nTasa de supervivencia general:", tasa_supervivencia_general)
...
print(f"\nIntervalo de confianza ({nivel_confianza * 100} %): [{limite_inferior}, {limite_superior}]")
...
print(f"\nT-statistic para mujeres: {t_stat_mujeres}, P-valor: {p_valor_mujeres}")
...
print(f"\nT-statistic para hombres: {t_stat_hombres}, P-valor: {p_valor_hombres}")
...
print(f"\nT-statistic para supervivencia por género: {t_stat_supervivencia}, P-valor: {p_valor_supervivencia}")
print("\nDiferencia significativa en la tasa de supervivencia entre hombres y mujeres (99%):", p_valor_supervivencia < 0.01)
...
print(f"\nF-statistic para supervivencia por clase: {t_stat_clase}, P-valor: {p_valor_clase}")
...
print(f"\nT-statistic para edad por género: {t_stat_edad}, P-valor: {p_valor_edad}")
